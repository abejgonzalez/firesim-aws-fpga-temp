create_project managed_ip_project $CL_DIR/ip/firesim_ila_ip/managed_ip_project -part xcvu9p-flgb2104-2-i -ip -force
...
set_property -dict [list CONFIG.C_PROBE0_WIDTH {1} CONFIG.C_PROBE0_MU_CNT {2} CONFIG.C_NUM_OF_PROBES {1} CONFIG.C_DATA_DEPTH {1024} CONFIG.C_TRIGOUT_EN {false} CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_ADV_TRIGGER {true} CONFIG.C_TRIGIN_EN {false} CONFIG.ALL_PROBE_SAME_MU_CNT {2} ] [get_ips ila_firesim_0]
