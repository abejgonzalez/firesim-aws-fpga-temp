...
#create_project -part [DEVICE_TYPE] -force FireSimProj $CL_DIR/build/${timestamp}
...
## store project
#archive_project -force $CL_DIR/build/checkpoints/${timestamp}.CL.pre_synth.proj_archive.zip
